...
#define	y_out	plhs[0]
    ...
    static void hyperlog_here( double y[], double x[], double T[], double W[], double M[], double A[], size_t size_m, size_t size_n)
    {
        try{
            Hyperlog *lg = new Hyperlog(T[0], W[0], M[0], A[0]);
